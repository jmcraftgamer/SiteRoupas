...
export function Location() {
  return (
    <section id="localizacao" className="py-28 lg:py-44 bg-brand-bg">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-green-600 text-white text-sm font-medium hover:bg-green-700 transition-all duration-300"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-brand-black text-white text-sm font-medium hover:bg-brand-pink hover:text-brand-black transition-all duration-300"
              >
                Ver no Google Maps
