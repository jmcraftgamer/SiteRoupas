...
export function WomenCollection() {
  return (
    <section id="feminino" className="py-20 lg:py-28 bg-brand-white overflow-hidden">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center lg:py-12">
            ...
            >
              ...
              <p className="mt-5 text-brand-gray leading-relaxed max-w-sm">
                Peças para acompanhar diferentes momentos, estilos e
                personalidades.
              </p>
            </motion.div>
            ...
            <div className="mt-10 grid grid-cols-2 gap-4">
              {womenProducts.slice(1).map((product, i) => (
                <motion.div
                  key={product.id}
